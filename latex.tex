...
\end{equation*}
	...
	(\url{http://bit.ly/lev-bishop-abs-norm}).}:
	\begin{latexcode}
\DeclarePairedDelimiter\abs{\lvert}{\rvert}
\DeclarePairedDelimiter\norm{\lVert}{\rVert}
	\end{latexcode}
	% <FIXME> \DeclarePairedDelimiter kräver \pack{mathtools}!
...
...flera rapporter \citeaffixed{Hassanpour08}{t.ex.}...
	...
	\subsection{Rekommenderade paket} % <HERE>
	% mathtools? många fler!
