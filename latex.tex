...
% the tocloft package requires lof and lot to exist
\makeatletter\let\l@figure\@empty\let\l@table\@empty\makeatother
...
\begin{document}
	...
	\LaTeX{} (uttalas \textipa{[\textprimstress lA:tEx]}) är i princip en
	...
	\mint{latex}|\documentclass[parametrar]{klass}|
	...
	\cmd{usepackage}:
	\mint{latex}|\usepackage[parametrar]{paketnamn}|
