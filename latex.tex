...
\ifdraft{%
% minted fixes <FIXME> (how do we account for options e.g. border?)
...
% tikz fixes
% not nessecary at the moment <FIXME>
% LaTeX source code
...
% Force cramped style on inline math (actually smashes instead)
...
\makeatother
% Useful colors
\definecolor{required}{rgb}{0.000,0.616,0.184}
\definecolor{optional}{rgb}{1.000,0.973,0.278}
\definecolor{unavailable}{rgb}{0.937,0.000,0.047}
%% (end)
...
% <FIXME>
% * \subsubsubsection needs starred variant to work properly
% * \cramped typesets a strange bar above (inline?) math
% * färgerna i bibtex-tabellen sticker ut riktigt mycket - byt ut!
% * generera omslaget i ett externt dokument!
...
\begin{document}
	...
	\begin{center} % DEDICATION, THANKS AND PUBLISHER
		...
		för inspirerande texter på samma tema.  % <FIXME>
		\vfill 
...
\subparagraph{...}  % Nivå 5
	...
	% <FIXME> polyglossia fungerar inte med pdflatex
...
\usepackage{amssymb}
	...
	ekvationer av större vikt). %% <FIXME> utveckla...
	...
	%% <FIXME> förklara tab:math:enkla närmre?
...
\SI{15}{\kilogram\metre\per\second\squared} % Tal med enhet
	...
	\addtocontents{toc}{\newpage} % <FIXME> toc hack for c5paper version
...
\end{tikzpicture}
	...
	\subsection{\BibTeX{} med \LaTeX{}} % <HERE>
...
\cite[s.~5]{Hassanpour08} % Skriver ut ”[1, s. 5]”
	...
	%Notera att man oftast bör använda \pack{harvard}
	%eller liknande paket om man vill ha en sådan stil, och att man oftast 
	%inte ska använda \texttt{apalike.bst}.
...
`-- FFM233-projekt
	...
	\begin{description}
		...
		det inte finns krav på stil från annat håll.
		
%		\item[\emph{\pack{harvard}}] % <FIXME>
	
%		\item[\pack{natbib}] % <FIXME>
	\end{description}
