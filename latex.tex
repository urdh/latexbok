\documentclass[swe,10pt,nofont,nocolor]{skrapport}
%% Packages (fold)
...
\end{tabular}
	...
	punktlistor. Det \citeasnoun{Sprakradet08} och \citename{LIU98} betecknar som
...
\usepackage{amssymb}
	...
	\begin{itemize}
		...
		kommandot \cmd{mathrm\{...\}}. Längre bitar text (eller snarare text
...
\end{align}
	...
	\vref{fig:aligngather:gather} hur omgivningen \env{subequations} fungerar. Denna
...
`-- FFM233-projekt
	...
	\begin{description}
		...
		med hjälp av kommandot \cmd{mathbold}.
	...
	\ifdraft{\inputminted[frame=single,firstline=1,lastline=12]{latex}{ex/A/mall.tex}}{\inputminted[frame=single,bgcolor=mintedbg,rulecolor=\color{mintedbg},firstline=1,lastline=12]{latex}{ex/A/mall.tex}}
	\newpage
	\ifdraft{\inputminted[frame=single,firstline=13,lastline=53]{latex}{ex/A/mall.tex}}{\inputminted[frame=single,bgcolor=mintedbg,rulecolor=\color{mintedbg},firstline=13,lastline=53]{latex}{ex/A/mall.tex}}
	\ifdraft{\inputminted[frame=single,firstline=54,lastline=94]{latex}{ex/A/mall.tex}}{\inputminted[frame=single,bgcolor=mintedbg,rulecolor=\color{mintedbg},firstline=54,lastline=94]{latex}{ex/A/mall.tex}}
	\ifdraft{\inputminted[frame=single,firstline=95,lastline=118]{latex}{ex/A/mall.tex}}{\inputminted[frame=single,bgcolor=mintedbg,rulecolor=\color{mintedbg},firstline=95,lastline=118]{latex}{ex/A/mall.tex}}
	%% (end)
