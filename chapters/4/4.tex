...
...från vilken typ av grafik du ska välja \parencite{Henry12} till hur
du ska sortera din data \parencite{Camoes10}.

Chart junk, axlar, figurtexter, färger, figurplacering(?), storlek,

\textcite{Tufte06}!

Fritt översatt från \textcite[\pno~13]{Tufte01}:
\begin{quotation}
	Utmärkt statistisk grafik består i att kommunicera komplicerade
	idéer med klarhet, precision och effektivitet. Grafik ska
	\begin{itemize}
		\item visa datan
		\item förmå läsaren att tänka på innehållet istället för metod, grafisk design, framställningstekniken eller något annat
		\item undvika att förvränga vad datan visar
		\item presentera många siffror på ett litet utrymme
		\item göra stora datamängder sammanhängande
		\item uppmuntra ögat att jämföra olika bitar av data
		\item uppenbara datan på flera detaljnivåer, från en bred översikt till den fina strukturen
		\item ha ett relativt klart syfte: beskrivning, utforskning, listning eller dekoration
		\item vara väl integrerade med de statistiska och verbala beskrivningarna av datamängden.
	\end{itemize}
	Grafik \emph{uppenbarar} data. Grafik kan vara med precis och avslöjande än konventionella statistiska beräkningar.
\end{quotation}
(Se även \textcite[\pno~51]{Tufte01}.)

FORTSÄTT PÅ SIDA 53 I Tufte01!

\Textcite{Tufte01} \enquote{pictures of numbers}.

\Textcite{Tufte90} \enquote{pictures of nouns}.

%\Textcite{Tufte97} \enquote{pictures of verbs}.
färgscheman \parencite[\ppno~75–77]{Tufte97} och
längdskalor \parencite[\ppno~20–23,103]{Tufte97}.
