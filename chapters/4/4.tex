...
% MORE! fördel/nackdel mot PGF/TikZ-export
...
\subsubsection{Exportera i \pack{pgfplots}-format}
\subsubsubsection*{Från \Rlogo med ???}
\subsubsubsection*{Från \MATLAB med ???}
\subsubsubsection*{Från \Mathematica med ???}
\subsubsubsection*{Från \gnuplot med ???}
...
enligt \cref{fig:graphicx}.% för att specificera detta.
...
\end{tikzpicture}
	...
	\begin{minipage}{0.95\textwidth} % figur
		...
		\textcite{Mertz07} och \textcite{Tantau10}. Tack till Alain 
