...
\usepackage[style=authoryear,sorting=nyt,sortcites=false,%
			...
			mergedate=basic,related=false,dashed=false,%
			backref=true,abbreviate=false]{biblatex}
% other stuff
\usepackage{siunitx}
\usepackage{hologo}
\let\sups\relax
...
\PassOptionsToPackage{hyperfootnotes=false,colorlinks=false,%
					  linkcolor=Red,urlcolor=Magenta}{hyperref}
\usepackage{varioref}
\usepackage{hyperref}
