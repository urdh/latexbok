...
\begin{description}
	...
	\item[\pack{inputenc}] (ej med \XeTeX och \hologo{LuaTeX})
	...
	stöds också.
	Detta paket introducerades lite kort på \cpageref{pack:inputenc}.
...
\begin{itemize}
	...
	\item Varken \pack{inputenc} eller \pack{fontenc} bör användas
...
ligger i att \pack{inputenc} och \pack{fontenc} inte bör användas (\XeTeX
