...
\begin{document}
\section{Referenser med \hologo{BibTeX}}\label{sec:5}
...
dokumenteras av \pack{btxhak} \parencite{Patashnik88b}, men detta är inte att
...
\subsection{\hologo{BibTeX}-databasen}
...
\Cref{ex:bibtex} visar ett block ur en \BibTeX-databas; blocket
