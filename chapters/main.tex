...
\begin{document}
	...
	\index{luaLaTeX@\luaLaTeX{}|see{kompilator, \luaLaTeX{}}}
	\index{XeLaTeX@\XeLaTeX{}|see{kompilator, \XeLaTeX{}}}
	...
	\index{filtyp!sty@filtyp!\texttt{.sty}|see{paket}}
	\index{filtyp!cls@filtyp!\texttt{.cls}|see{dokumentklass}}
	\index{filtyp!pdf@filtyp!\texttt{.pdf}|see{\PDF}}
	%
	\cleardoublepage
