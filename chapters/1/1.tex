...
\index{dokumentklass!standardklass|seealso{inställningar, standardklass}}
...
\begin{description}[font=\ttfamily]
	...
	\index{filtyp!sty@\texttt{.sty}|seealso{paket}}
	...
	\index{filtyp!cls@\texttt{.cls}|seealso{dokumentklass}}
...
\begin{description}[font=\ttfamily]
	\index{filtyp!pdf@\texttt{.pdf}|seealso{\PDF}}
