...
\index{filtyp!tex@filtyp!\texttt{.tex}}
\index{teckenkodning}
...
\index{syntax}
\index{tomrum!i LaTeX-koden@tomrum!i \LaTeX-kod}
...
\index{inställning!standardklass}
...
\index{kompilator}
\index{PDF!kompilera till@\PDF!kompilera till}
...
\index{filtyp!övriga}
\index{filtyp!aux@filtyp!\texttt{.aux}}
\index{filtyp!log@filtyp!\texttt{.log}}
\index{filtyp!toc@filtyp!\texttt{.toc}}
\begin{description}[font=\ttfamily]
